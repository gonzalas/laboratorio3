...
public class AdventureMovie extends Movie{
    ...
    public AdventureMovie(String name, int releaseDate, int duration, String audienceRating, String country, String description, int copies) {
        super(name, releaseDate, duration, audienceRating, country, description, copies);
        this.gender = "Adventure";
    }
